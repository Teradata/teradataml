...
teradataml provides Geospatial functions that enables data manipulation, exploration and analysis on tables, views, and queries on Teradata Vantage that contains Geospatial data.
